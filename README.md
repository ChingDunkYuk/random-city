...
没有信息流、没有攻略墙,只有 150 座精心挑选的城市和一颗骰子。

## 功能

| 模块 | 内容 |
|---|---|
| 🎲 随机 | 150 城覆盖六大洲,洗牌滚动动画 + Reveal 动效 + 震动反馈 |
...
- 离线优先:城市数据 + 150 张代表图全部内置,断网可用(联网仅用于天气)
- 浅色卡片风 UI,完整深色模式
...
├─ assets/
│  ├─ data/
│  │  ├─ cities.json         # 150 城结构数据(id/坐标/天数/预算/标签…)
│  │  └─ cities_zh.json      # 150 城中文文案(景点/美食/住宿/路线/贴士…)
│  └─ city_images/           # 150 张内置代表图(WebP 800×450,人工质检)
